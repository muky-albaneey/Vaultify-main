...
if USE_S3:
    # Default/uploaded media -> S3-compatible storage
    STORAGES = {
        "default": {
            "BACKEND": "storages.backends.s3boto3.S3Boto3Storage",
        },
        # Keep static via WhiteNoise on Render (fast, simple)
        "staticfiles": {
    ...
    AWS_S3_REGION_NAME = os.getenv("AWS_S3_REGION_NAME")         # e.g. "eu-central-1"
    AWS_S3_ENDPOINT_URL = os.getenv("AWS_S3_ENDPOINT_URL")       # Linode: e.g. "https://eu-central-1.linodeobjects.com"
    AWS_S3_SIGNATURE_VERSION = "s3v4"
    AWS_S3_ADDRESSING_STYLE = "virtual"  # or "path" if your provider needs it

    # public-read media by default (tweak as needed)
    AWS_DEFAULT_ACL = "public-read"
    AWS_QUERYSTRING_AUTH = False
    AWS_S3_FILE_OVERWRITE = False

    # Useful when building absolute media URLs
    if os.getenv("AWS_S3_CUSTOM_DOMAIN"):
        AWS_S3_CUSTOM_DOMAIN = os.getenv("AWS_S3_CUSTOM_DOMAIN")
        MEDIA_URL = f"https://{AWS_S3_CUSTOM_DOMAIN}/"
    else:
        # Works for Linode & most S3 compatibles
